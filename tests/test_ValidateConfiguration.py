...
class TestValidateConfiguration(TestCase):
    ...
    def test_check_master_vpn_worker_ordered(self):
        ...
        vc = validateConfiguration.ValidateConfiguration(providers=None, configurations=[master])
    ...
    def test_check_master_vpn_worker_unique(self):
        ...
        vpn_master.update(master)
        vpn_master.update(vpn)
        vc = validateConfiguration.ValidateConfiguration(providers=None, configurations=[vpn_master])
        self.assertFalse(vc.check_master_vpn_worker())
    ...
    def test_check_provider_connection(self):
        mock = Mock()
        mock.conn = False
        vc = validateConfiguration.ValidateConfiguration(providers=[mock], configurations=None)
    ...
    def test_check_instances_master(self):
        vc = validateConfiguration.ValidateConfiguration(providers=["31"], configurations=[{"masterInstance": "42"}])
        with patch.object(vc, "check_instance") as mock:
            vc.check_instances()
            mock.assert_called_with("masterInstance", "42", "31")

    def test_check_instances_vpn(self):
        vc = validateConfiguration.ValidateConfiguration(providers=["31"], configurations=[{"vpnInstance": "42"}])
        with patch.object(vc, "check_instance") as mock:
            vc.check_instances()
            mock.assert_called_with("vpnInstance", "42", "31")

    def test_check_instances_vpn_worker(self):
        vc = validateConfiguration.ValidateConfiguration(providers=["31"], configurations=[
    ...
    def test_check_instances_vpn_master_missing(self):
        ...
        vc = validateConfiguration.ValidateConfiguration(providers=["31"], configurations=[{"workerInstances": ["42"]}])
        self.assertFalse(vc.check_instances())
    ...
    def test_check_volumes_none(self):
        vc = validateConfiguration.ValidateConfiguration(providers=[42], configurations=[{}])
    ...
    def test_check_volumes_mismatch(self):
        ...
        vc = validateConfiguration.ValidateConfiguration(providers=[provider],
    ...
    def test_check_volumes_match_snapshot_count(self):
        for i in range(3):
            ...
            vc = validateConfiguration.ValidateConfiguration(providers=[provider] * i,
    ...
    def test_check_quotas_true(self):
        ...
        vc = validateConfiguration.ValidateConfiguration(providers=[provider], configurations=None)
        with patch.object(vc, "has_enough") as mock:
