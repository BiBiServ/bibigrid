...
class TestProviderHandler(TestCase):
    ...
    @patch("bibigrid.core.utility.handler.configurationHandler.get_cloud_specifications")
    @patch("bibigrid.core.utility.handler.providerHandler.get_provider_list_by_name_list")
    def test_get_providers(self, mock_provider_list, mock_get_cloud_specifications):
        ...
        with patch("bibigrid.core.utility.handler.configurationHandler.get_list_by_key") as mock_by_name:
    ...
    def test_get_provider_list_by_name_list(self):
        ...
        values = [42]
        with patch("bibigrid.core.utility.handler.providerHandler.get_provider_by_name") as mock_by_name:
