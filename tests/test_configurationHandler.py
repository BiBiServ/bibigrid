...
class TestConfigurationHandler(TestCase):
    ...
    @patch("os.path.isfile")
    @patch("bibigrid.core.utility.handler.configurationHandler.read_configuration")
    ...
    @patch("bibigrid.core.utility.handler.configurationHandler.find_file_in_folders")
    ...
    @patch("bibigrid.core.utility.handler.configurationHandler.get_cloud_specification")
    @patch("bibigrid.core.utility.handler.configurationHandler.get_clouds_files")
