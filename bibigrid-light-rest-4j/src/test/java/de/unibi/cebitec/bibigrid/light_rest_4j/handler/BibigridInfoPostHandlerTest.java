...
@Ignore
public class BibigridInfoPostHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(BibigridInfoPostHandlerTest.class);
    ...
    @Test
    public void testBibigridInfoPostHandlerTest() throws ClientException {
        ...
        String requestUri = "/bibigrid/info";
