...
@Ignore
public class BibigridScaleIdPostHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(BibigridScaleIdPostHandlerTest.class);
    ...
    @Test
    public void testBibigridScaleIdPostHandlerTest() throws ClientException {
        ...
        String requestUri = "/bibigrid/scale/gAGygtedOyTUHZVOK";
