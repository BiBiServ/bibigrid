...
public class BibigridScaleIdPostHandlerTest {
    ...
    */
    static final String NO_ENV_VARS = "{\"message\":\"Failed to connect openstack client: NullPointerException: null. This is most likely caused by not sourcing the CloudComputingOpenRC.sh file.\"}";
