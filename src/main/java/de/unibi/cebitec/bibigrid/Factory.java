...
public final class Factory {
    ...
    public <T> List<Class<T>> getImplementations(Class<T> classInterface) {
        if (interfaceClassMap.containsKey(classInterface.getName())) {
            List<Class<T>> result = new ArrayList<>();
            for (Class<?> clazz : interfaceClassMap.get(classInterface.getName())) {
