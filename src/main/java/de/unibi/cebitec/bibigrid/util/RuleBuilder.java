...
public class RuleBuilder {
    ...
    public RuleBuilder(){
        ...
        group.getParamrefOrParamGroupref().add(createBasicRule( "ansadd", "ansible-additionals", Tprimitive.STRING, "Path to folder containing ansible playbooks which will be copied to the master instance."));

        //.addOption("ansadd", "ansible-additionals", false, "Path to folder containing ansible playbooks which will be copied t
    }
