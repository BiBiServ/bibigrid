...
GROUP_VARS_FOLDER_REMOTE = os.path.join(PLAYBOOK_PATH_REMOTE, GROUP_VARS_PATH)
HOST_VARS_FOLDER_REMOTE = os.path.join(PLAYBOOK_PATH_REMOTE, HOST_VARS_PATH)
HOSTS_FILE_REMOTE = os.path.join(PLAYBOOK_PATH_REMOTE, HOSTS_YAML)
