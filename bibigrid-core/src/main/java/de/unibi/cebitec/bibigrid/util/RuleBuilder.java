...
public class RuleBuilder {
    ...
    public RuleBuilder(){
        ...
        basicGroup.getParamrefOrParamGroupref().add(createBasicRule("usir", "use-spot-instance-request", Tprimitive.BOOLEAN, " Yes or No of spot instances should be used  (Type t instance types are unsupported).", "intermediate"));
        ...
        basicGroup.getParamrefOrParamGroupref().add(createBasicRule("z", "availability-zone", Tprimitive.STRING, "e.g. availability-zone=eu-west-1a", "expert")); 
        ...
        basicGroup.getParamrefOrParamGroupref().add(createBasicRule("f", "slave-mounts", Tprimitive.STRING, "comma-separated snapshot=mountpoint list (e.g. snap-12234abcd=/mnt/mydir1,snap-5667889ab=/mnt/mydir2) mounted to all slaves individually", "intermediate"));
        ...
        basicGroup.getParamrefOrParamGroupref().add(createBasicRule("lfs", "local-fs", Tprimitive.STRING, "File system used for internal (empheral)); diskspace. One of 'ext2', 'ext3', 'ext4' or 'xfs'. Default is 'xfs'.", "intermediate")); 
        ...
        basicGroup.getParamrefOrParamGroupref().add(createBasicRule("ose", "openstack-endpoint", Tprimitive.STRING, "The given Openstack Endpoint e.g. (http://xxx.xxx.xxx.xxx:5000/v2.0/));", "beginner")); 
