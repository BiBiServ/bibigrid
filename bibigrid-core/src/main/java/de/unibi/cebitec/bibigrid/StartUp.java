...
public class StartUp {
    ...
    public static OptionGroup getCMDLineOptionGroup() {
        ...
        TparamGroup intRuleSet = ruleBuild.getIntentRules();

        for (Object ob : intRuleSet.getParamrefOrParamGroupref()) {
            ...
            intentOptions.addOption(new Option(tp.getId(), tp.getOption(), hasArg, tp.getShortDescription().get(0).getValue()));
        }
    ...
    public static Options getCMDLineOptions(OptionGroup optgrp) {
        ...
        RuleBuilder ruleBuild = new RuleBuilder();
        TparamGroup ruleSet = ruleBuild.getBasicRules();
        Options cmdLineOptions = new Options();

        cmdLineOptions.addOptionGroup(optgrp);
        ...
        for (Object ob : ruleSet.getParamrefOrParamGroupref()) {
            ...
            cmdLineOptions.addOption(new Option(tp.getId(), tp.getOption(), hasArg, tp.getShortDescription().get(0).getValue()));
        }
